...
- exp：以自然常数e为底的指数函数，exp(x)表示e的x次幂，e~2.71828
...
![image-20241203101339995.png](./assets/image-20241203101339995.png)

C和Ck分别表示类别标签的总数和第K个客户端的多数类标签的数量。

详细的训练过程：

![image-20241203102613368.png](./assets/image-20241203102613368.png)
